...
public interface Constants {
	...
	final String LOAD_BALANCE_CUSTALGO = "Custom Algorithm";
	final String LOAD_BALANCE_CUSTALGO2 = "SJF-Cloudletbased";
	final String LOAD_BALANCE_CUSTALGO3 = "SJF_VmLoadBalance";
