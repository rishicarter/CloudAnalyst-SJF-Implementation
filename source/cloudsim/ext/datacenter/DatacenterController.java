...
public class DatacenterController extends DatacenterBroker implements GeoLocatable,
	...
	public DatacenterController(String name, 
		...
		}if (loadBalancePolicy.equals(Constants.LOAD_BALANCE_CUSTALGO2)) {
			this.loadBalancer = new SJF_Cloudletbased(this);
		}if (loadBalancePolicy.equals(Constants.LOAD_BALANCE_CUSTALGO3)) {
			this.loadBalancer = new SJF_VmLoadBalance(this);
		}if (loadBalancePolicy.equals(Constants.LOAD_BALANCE_CUSTALGO)){
			this.loadBalancer = new CustomAlgorithm(this); 
